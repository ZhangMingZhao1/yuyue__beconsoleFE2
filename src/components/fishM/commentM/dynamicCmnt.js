...
class DynamicCmnt extends React.Component {
    ...
    requestList = () => {
        ...
        // 翻页
        fetch(`${URL}/shoal/userdynamiccmnts/${this.props.match.params.id}?${parseParams(params)}`, {
            method: 'GET',
            credentials: 'include'
        })
            .then((res) => res.json())
    ...
    dynamicCmntSearch = () => {
        ...
        fetch(`${URL}/shoal/userdynamiccmnts/${this.props.match.params.id}` +
    ...
    dynamicCmntDelete = () => {
        ...
        confirm({
            ...
            cancelText: '取消',
            onOk: () => {
                fetch(`${URL}/shoal/userdynamiccmnts`, {
                    method: 'POST',
                    mode: "cors",
                    headers: {
