...
class CheckList extends React.Component {
    state = {
        ...
        dataSource: [
            { key: 1, caseCode: "100", bookName: "小岛经济学", rfid: "78364178326148", state: "已下柜" },
            { key: 2, caseCode: "100", bookName: "小岛经济学", rfid: "78364178326148", state: "已取消" },
            { key: 3, caseCode: "100", bookName: "小岛经济学", rfid: "78364178326148", state: "已下柜" },
        ],
        reason: "",
        total: 100, //格子总数
        full: 10, //补齐格子数
            ...
            <div>
                <Card>
                    <div style={{ textAlign: 'right' }}>
                        <Button type="primary" disabled>已下柜</Button>
                    </div>
                    ...
                    <Table
                        ...
                        footer={() => <p>共计：{total}个空格，已完成{full}个格子补书&emsp;&emsp;<font style={{ color: "red" }}>存在一个差异</font></p>}
                        bordered
                    />
                    <p>
                        备注：<TextArea value={this.state.reason} onChange={(v) => { this.setState({ reason: v }) }} />
                    </p>
                    <div style={{ textAlign: "center" }}>
                        <Button style={{ marginRight: '50px' }} size="large" type="primary">审核通过</Button>
                        <Button size="large" type="primary">审核不通过</Button>
                    </div>
                </Card>
            </div>
        )
