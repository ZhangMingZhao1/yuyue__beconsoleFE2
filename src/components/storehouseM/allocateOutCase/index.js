...
class AllocateOutCase extends React.Component {
    render() {
        const columns = [
        ...
        const action = {
            "0": [{ label: '修改', onClick: () => { this.props.history.push("/app/storehouseM/transferOutData/generate") } }],
            "1": [{ label: '修改', onClick: () => { } }],
            "2": [{ label: '接单', onClick: (record) => { this.props.history.push("/app/storehouseM/transferOutData/receive") } }],
            "3": [{ label: '下柜', onClick: (record) => { this.props.history.push("/app/storehouseM/transferOutData/put") } }, { label: '打印单据', onClick: (record) => { } }],
            "4": [{ label: '审核', onClick: (record) => { this.props.history.push("/app/storehouseM/transferOutData/check") } }],
            "5": [{ label: '查看', onClick: (record) => { this.props.history.push("/app/storehouseM/transferOutData/finished") } }],
        }

        return (
            <div className="">
                <BreadcrumbCustom first="仓库管理" second="调拨出柜单" />
                <Card
                    title="调拨出柜单查询"
                >
                    <AOCSearch />
                    <div style={{ textAlign: "right" }}>
                        <Button 
                            ...
                            type="primary"
                            onClick={() => { this.props.history.push("/app/storehouseM/transferOutData/generate") }}
                        >
                            新建
                        </Button>
                    </div>
                    <Table
                        ...
                        columns={columns}
                        dataSource={[{ key: 0, state: 0 }, { key: 1, state: 1 }, { key: 2, state: 2 }, { key: 3, state: 3 }, { key: 4, state: 4 }, { key: 5, state: 5 }]}
                        pagination={{
...
export default AllocateOutCase;